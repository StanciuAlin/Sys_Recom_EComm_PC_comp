...
namespace Sys_Recom_EComm_PC_comp.Controllers
{
    public class UserProfilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UserProfileID,CustomerID,KeywordID,Searches")] UserProfile userProfile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("UserProfileID,CustomerID,KeywordID,Searches")] UserProfile userProfile)
        {
